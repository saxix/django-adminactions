    ...
    $(function () {
        $(".func_select").change(function () {
            ...
            var target = $(this)
                ...
                .parent()
                .find(
                    ".col_field input, .col_field select .col_field textarea",
                );
        ...
        $(
            ".col_field input, .col_field select, .col_field textarea, .col_func select",
        ).each(function () {
            if (
                !$(this)
                    .parent()
                    .parent()
                    .find(".col_enabler input[type=checkbox]")
                    .is(":checked")
            ) {
