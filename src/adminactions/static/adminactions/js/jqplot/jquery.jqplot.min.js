(function (L) {
    ...
    L.jqplot.CanvasManager = function () {
        ...
        this.getCanvas = function () {
            ...
            if (!L.jqplot.use_excanvas) {
                for (
                    var al = 0, ai = L.jqplot.CanvasManager.canvases.length;
                    al < ai;
                    al++
                ) {
            ...
            if (ap.show || this.scaleToHiddenSeries) {
                ...
                for (var ak = 0, ai = am.length; ak < ai; ak++) {
                    if (this.name == "xaxis" || this.name == "x2axis") {
                        if (
                            (am[ak][0] != null && am[ak][0] < ao.min) ||
                            ao.min == null
                        ) {
                            ao.min = am[ak][0];
                        }
                        if (
                            (am[ak][0] != null && am[ak][0] > ao.max) ||
                            ao.max == null
                        ) {
                            ao.max = am[ak][0];
                        }
                        ...
                        if (
                            (am[ak][ah] != null && am[ak][ah] < ao.min) ||
                            ao.min == null
                        ) {
                            ao.min = am[ak][ah];
                        }
                        if (
                            (am[ak][an] != null && am[ak][an] > ao.max) ||
                            ao.max == null
                        ) {
                            ao.max = am[ak][an];
                        }
    ...
    S.prototype.toggleDisplay = function (ai, ak) {
        ...
        if (aj) {
            if (ah.canvas._elem.is(":hidden") || !ah.show) {
                ...
                ah.canvas._elem
                    .nextAll(".jqplot-point-label.jqplot-series-" + ah.index)
                    .fadeIn(aj);
            } else {
                ah.show = false;
    ...
    function R() {
        ...
        this.init = function (av, ar, ay) {
                ...
                if (this.noDataIndicator.show == false) {
                    ...
                    for (var al in this.noDataIndicator.axes) {
                        for (var an in this.noDataIndicator.axes[al]) {
                            this.axes[al][an] =
                                this.noDataIndicator.axes[al][an];
                        }
                    }
            ...
            for (var at = 0; at < this.series.length; at++) {
                ...
                this.series[at].shadowCanvas._plotDimensions =
        ...
        this.reInitialize = function (au, al) {
            ...
            for (var av = 0, aq = this.series.length; av < aq; av++) {
                ...
                this.series[av].shadowCanvas._plotDimensions =
                    this._plotDimensions;
        ...
        this.parseOptions = function (ay) {
            ...
            for (var at = 0; at < this.data.length; at++) {
                ...
                var ao = "vertical";
                if (
                    ax.renderer === L.jqplot.BarRenderer &&
                    ax.rendererOptions &&
        ...
        this.draw = function () {
            if (this.drawIfHidden || this.target.is(":visible")) {
                ...
                for (
                    var aH = 0, aE = this.eventListenerHooks.hooks.length;
                    aH < aE;
                    aH++
                ) {
                    this.eventCanvas._elem.bind(
                ...
                for (aH = 0, aE = aJ; aH < aE; aH++) {
                    ...
                    if (
                        ...
                        av.canvas._elem.jqplotEffect(
                            "blind",
                            { mode: "show", direction: aw.animation.direction },
                            aw.animation.speed,
                        );
    ...
    function n(aj, ai) {
        var ah = Math.sqrt(
            Math.pow(ai[0] - aj[0], 2) + Math.pow(ai[1] - aj[1], 2),
        );
    ...
    function J(aJ) {
        ...
        for (var al = 1, aB = aJ.length; al < aB; al++) {
                    ...
                    if (aw[aE + 1] - aw[aE] == 0 || aw[aE] - aw[aE - 1] == 0) {
                        ...
                        if (
                            (ak[aE + 1] - ak[aE]) / (aw[aE + 1] - aw[aE]) +
                                (ak[aE] - ak[aE - 1]) / (aw[aE] - aw[aE - 1]) ==
                            0
                        ) {
                            ai[aC] = 0;
                        } else {
                            if (
                                (aw[aE + 1] - aw[aE]) * (aw[aE] - aw[aE - 1]) <
                                0
                            ) {
                                ai[aC] = 0;
                            } else {
            ...
            if (al == 1) {
                ai[0] =
                    ((3 / 2) * (aw[1] - aw[0])) / av(ak[1], ak[0]) - ai[1] / 2;
            } else {
                if (al == ah) {
                    ai[1] =
                        ((3 / 2) * (aw[ah] - aw[ah - 1])) /
            ...
            aq =
                ((1 / 2) * (ak[al] * au[0] - ak[al - 1] * au[1])) /
                av(ak[al], ak[al - 1]);
            ar =
                (aw[al] -
                    aw[al - 1] -
                    aq * (Math.pow(ak[al], 2) - Math.pow(ak[al - 1], 2)) -
                    ap * (Math.pow(ak[al], 3) - Math.pow(ak[al - 1], 3))) /
                av(ak[al], ak[al - 1]);
            ax =
                aw[al - 1] -
                ar * ak[al - 1] -
            ...
            for (var aC = 0, aA = aF; aC < aA; aC++) {
                ...
                aH.push(ao);
                aH.push(
                    ax + ar * ao + aq * Math.pow(ao, 2) + ap * Math.pow(ao, 3),
                );
                aj.push(aH);
    ...
    function F(ap) {
        ...
        for (var aQ = 0, aP = ap.length - 1; aQ < aP; aQ++) {
            if (aU === null) {
                at = Math.abs(
                    (ap[aQ + 1][1] - ap[aQ][1]) / (ap[aQ + 1][0] - ap[aQ][0]),
                );
                aS = 0.3;
                ax = 0.6;
                aF = (ax - aS) / 2;
                ...
                if (aA) {
                    ...
                    if (this.renderer.bands.show) {
                        ...
                        if (this.renderer.bands.fill) {
                            if (this.renderer.smooth) {
                                am = this.renderer._hiBandSmoothedData.concat(
                                    this.renderer._lowBandSmoothedData.reverse(),
                                );
                            } else {
                                am = this.renderer._hiBandGridData.concat(
                ...
                if (this.autoscale && this.min == null && this.max == null) {
                    ...
                    for (var a0 = 0; a0 < this._series.length; a0++) {
                        ...
                        if (this.name == aD) {
                            ...
                            var au = (a2 - aG) / a2;
                            if (
                                aV.renderer.constructor == L.jqplot.BarRenderer
                            ) {
                    ...
                    if (aC) {
                        ...
                        at = Math.pow(
                            10,
                            Math.abs(Math.floor(Math.log(al) / Math.LN10)),
                        );
                        ...
                        if (aN) {
                            ...
                            var aJ = Math.ceil(
                                (Math.abs(a6) / av) * (this.numberTicks - 1),
                            );
                    ...
                    if (this.numberTicks == null) {
                        if (this.tickInterval != null) {
                            this.numberTicks =
                                Math.ceil((ay - aS) / this.tickInterval) + 1;
                        } else {
                            if (ah > 100) {
                    ...
                    if (aL) {
                        ...
                        if (this.tickInterval < aq) {
                            if (aW == null && ba == null) {
                                ...
                                if (a5 == null && aH == null) {
                                    this.min =
                                        Math.floor(this._dataBounds.min / aq) *
                                        aq;
                                    ...
                                    this.max =
                                        Math.ceil(this._dataBounds.max / aq) *
                                        aq;
        ...
        if (this.breakPoints) {
            ...
            this.u2p = function (aA) {
                ...
                if (aA <= this.breakPoints[0]) {
                    ...
                    return (
                        ((aA - this.breakPoints[1] + this.breakPoints[0] - at) *
                            ak) /
                            al +
                        am
                    );
            ...
            if (this.name == "xaxis" || this.name == "x2axis") {
                for (var av = 0; av < ay.length; av++) {
                    ...
                    if (ap.show && ap.showLabel) {
                        var ah;
                        if (
                            ap.constructor == L.jqplot.CanvasAxisTickRenderer &&
                            ap.angle
                        ) {
    ...
    L.jqplot.ShadowRenderer.prototype.draw = function (av, at, ax) {
        ...
        av.strokeStyle =
            ah.strokeStyle || this.strokeStyle || "rgba(0,0,0," + aj + ")";
        av.fillStyle =
            ah.fillStyle || this.fillStyle || "rgba(0,0,0," + aj + ")";
            ...
            if (this.placement == "insideGrid") {
                switch (this.location) {
                    ...
                    case "n":
                        var ai =
                            (aj.left +
                                (this._plotDimensions.width - aj.right)) /
                                2 -
                            this.getWidth() / 2;
                        var ah = aj.top;
                        this._elem.css("left", ai);
        ...
        if (!this.themes.hasOwnProperty(aB)) {
            ...
            for (var az in av.axes) {
                ...
                if (ak.show) {
                    ...
                    aA =
                        am.axesStyles.borderColor != null
                    ...
                    aA =
                        am.axesStyles.borderWidth != null
                ...
                for (au in am.series[aw]) {
                    ...
                    if (aA != null) {
                        ...
                        if (au == "color") {
                            ...
                            av.series[aw].renderer.shapeRenderer.strokeStyle =
                                aA;
                            av.series[aw][au] = aA;
                        } else {
                ...
                if (aN === "table" && L(aG).hasClass("jqplot-table-legend")) {
                    ...
                    L(aG)
                        ...
                        .each(function () {
                            ...
                            var aT =
                                aU.innerHeight() -
                                2 * parseInt(aU.css("padding-top"), 10);
                            var aP =
                                aU.innerWidth() -
                                2 * parseInt(aU.css("padding-left"), 10);
                            var aS = aU.children(
    ...
    ag.prototype.strftime = function (ah) {
        ah =
            ah || this.formatString || ag.regional[this.locale]["formatString"];
    ...
    var E = {
        ...
        year: {
            add: function (ai, ah) {
                ai.setYear(
                    ai.getFullYear() + Math[ah > 0 ? "floor" : "ceil"](ah),
                );
            },
            diff: function (ai, ah) {
        ...
        function ak(ar) {
            ...
            for (var ap = 10; ap > 0; ap--) {
                if (
                    ...
                    (aq = aq.replace(
                        /^(\d+)(\d{3})/,
                        "$1" + L.jqplot.sprintf.thousandsSeparator + "$2",
                    ))
                ) {
                    break;
                }
            ...
            function (aM, ax, ay, aB, aO, aJ, av) {
                ...
                switch (av) {
                    ...
                    case "G":
                        ...
                        var aH = ar < 0 ? "-" : az;
                        var at = ["toExponential", "toFixed", "toPrecision"][
                    ...
                    case "P":
                        ...
                        if (Math.abs(ar) < 1) {
                            if (aq + aG <= aJ) {
                                ...
                                if (aq <= aJ - 1) {
                                    aF =
                                        aH + Math.abs(ar).toExponential(aq - 1);
                                } else {
                                    aF =
                                        aH + Math.abs(ar).toExponential(aJ - 1);
                                }
                            }
                        } else {
                            var ap = aq <= aJ ? aq : aJ;
