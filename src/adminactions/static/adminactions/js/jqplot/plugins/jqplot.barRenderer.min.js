(function (d) {
    ...
    function g(t, p, o, w) {
        ...
        if (this.rendererOptions.waterfall == true) {
            ...
            this.data[this.data.length] =
                u == 1 ? [this.data.length + 1, s] : [s, this.data.length + 1];
            this._data[this._data.length] =
                u == 1
                    ? [this._data.length + 1, s]
                    : [s, this._data.length + 1];
        }
    ...
    d.jqplot.BarRenderer.prototype.setBarWidth = function () {
        ...
        if (t.name == "xaxis" || t.name == "x2axis") {
            if (this._stack) {
                this.barWidth =
                    ((t._offsets.max - t._offsets.min) / n) * o -
                    this.barMargin;
            } else {
                this.barWidth =
                    ((t._offsets.max - t._offsets.min) / p -
                        this.barPadding * (o - 1) -
                        this.barMargin * 2) /
                    o;
            }
            ...
            if (this._stack) {
                this.barWidth =
                    ((t._offsets.min - t._offsets.max) / n) * o -
                    this.barMargin;
            } else {
                this.barWidth =
                    ((t._offsets.min - t._offsets.max) / p -
                        this.barPadding * (o - 1) -
                        this.barMargin * 2) /
                    o;
            }
    ...
    function i(v, u, s, t, o) {
        ...
        if (q > 0) {
            ...
            n =
                r === 0
                    ? t.series[q]._xaxis.series_u2p(0)
    ...
    d.jqplot.BarRenderer.prototype.draw = function (E, L, q, G) {
        ...
        if (this.highlightColors.length == 0) {
            this.highlightColors = d.jqplot.computeHighlightColors(
                this._dataColors,
            );
        } else {
    ...
    function b(r, q, u, t, s) {
        if (t) {
            ...
            if (
                ...
                !(
                    p[0] == s.plugins.barRenderer.highlightedSeriesIndex &&
